...
const handleLogout = () => {
  ...
  return (
    <div className="navbar">
      <h2 className="navbar-title">Project Management System [PMS]</h2>

      <div className="nav-actions">
        <div className="profile-wrapper" title={userName || "Profile"}>
          <FaUserCircle className="nav-icon profile-icon" />
          Welcome [ <span className="nav-name">{userName || "Guest"}</span> ]
        </div>
